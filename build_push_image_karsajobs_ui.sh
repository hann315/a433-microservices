...
# build image docker dari Dockerfile dari current working directory dengan nama hann315/karsajobs-ui dan tag lastest
docker build -t hann315/karsajobs-ui:latest .
# membuat line baru
echo '\n\n'

# membuat tag image baru dari source image menggunakan image hann315/karsajobs:latest, tetapi dengan nama/tag yang beda
docker tag hann315/karsajobs-ui:latest ghcr.io/hann315/karsajobs-ui:latest
# membuat line baru
echo '\n\n'
...
docker push ghcr.io/hann315/karsajobs-ui:latest
# membuat line baru
echo '\n\n'